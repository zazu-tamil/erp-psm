...
INSERT INTO `menu_info` (`menu_id`,`parent_id`,`menu_title`,`menu_slug`,`menu_icon`,`is_header`,`sort_order`,`status`) VALUES
  ...
  (53, 49, 'Customer Invoice Report', 'customer-invoice-pending-report', 'fa fa-file-text', 0, 53, 'Active'),
  (54, 49, 'Vendor Invoice Report', 'vendor-invoice-pending-report', 'fa fa-file-text', 0, 54, 'Active'),
