...
INSERT INTO `menu_info` (`menu_id`,`parent_id`,`menu_title`,`menu_slug`,`menu_icon`,`is_header`,`sort_order`,`status`) VALUES
  ...
  (49, 48, 'Tender Report', NULL, 'fa fa-file-text-o', 0, 49, 'Active'),
  ...
  (54, 49, 'Customer Statement Report', 'customer-statement-report', 'fa fa-file-text', 0, 54, 'Active'),
  (55, 49, 'Invoice Summary Report', 'invoice-report', 'fa fa-file-text', 0, 55, 'Active'),
  (56, 49, 'Tender Progress Report', 'tender-progress-report', 'fa fa-line-chart', 0, 56, 'Active'),
  (57, 48, 'Supplier Report', NULL, 'fa fa-industry', 0, 57, 'Active'),
  (58, 57, 'Vendor Pending Report', 'vendor-pending-invoice-report', 'fa fa-file-text', 0, 58, 'Active'),
  (59, 57, 'Vendor Statement Report', 'vendor-statement-report', 'fa fa-file-text', 0, 59, 'Active'),
  (60, 57, 'PO Summary Report', 'supplier-summary-report', 'fa fa-file-text', 0, 60, 'Active'),
  (61, 48, 'NBR Report', NULL, 'fa fa-envelope', 0, 61, 'Active'),
  (62, 61, 'VAT Return Form Summary', 'sales-purchase-report', 'fa fa-list', 0, 62, 'Active'),
  (63, 61, 'Sales NBR Report', 'sales-nbr-report', 'fa fa-list', 0, 63, 'Active'),
  (64, 61, 'Purchase NBR Report', 'purchase-nbr-report', 'fa fa-list', 0, 64, 'Active'),
  (65, 48, 'Profit & Loss', 'pl-report', 'fa fa-line-chart', 0, 65, 'Active'),
  (66, 48, 'Account Trial Balance', 'account-trial-balance', 'fa fa-balance-scale', 0, 66, 'Active'),
  (67, 0, 'Accounts Book Info', NULL, NULL, 1, 67, 'Active'),
  (68, 0, 'Accounts Book Info', NULL, 'fa fa-file-text', 0, 68, 'Active'),
  (69, 68, 'Inward Entry', 'inward-list', 'fa fa-plus-circle', 0, 69, 'Active'),
  (70, 68, 'Outward Entry', 'outward-list', 'fa fa-list-ul', 0, 70, 'Active'),
  (71, 68, 'Contra Entry', 'contra-entry', 'fa fa-exchange', 0, 71, 'Active'),
  (72, 68, 'Bank Statement', 'cash-in-out-statement', 'fa fa-university', 0, 72, 'Active'),
  (73, 68, 'Cash Statement', 'petty-cash-statement', 'fa fa-file-text-o', 0, 73, 'Active'),
  (74, 68, 'Credit/Debit Note', NULL, 'fa fa-file-text-o', 0, 74, 'Active'),
  (75, 74, 'Add Credit/Debit Note', 'credit-debit-note-add', 'fa fa-plus-circle', 0, 75, 'Active'),
  (76, 74, 'Credit/Debit Note List', 'credit-debit-note-list', 'fa fa-list-ul', 0, 76, 'Active'),
  (77, 0, 'Master', NULL, NULL, 1, 77, 'Active'),
  (78, 0, 'Master', NULL, 'fa fa-cubes', 0, 78, 'Active'),
  (79, 78, 'General', NULL, 'fa fa-cog', 0, 79, 'Active'),
  (80, 79, 'Category List', 'category-list', 'fa fa-folder-open', 0, 80, 'Active'),
  (81, 79, 'Brand List', 'brand-list', 'fa fa-industry', 0, 81, 'Active'),
  (82, 79, 'Items List', 'items-list', 'fa fa-cubes', 0, 82, 'Active'),
  (83, 79, 'UOM List', 'uom-list', 'fa fa-balance-scale', 0, 83, 'Active'),
  (84, 79, 'VAT List', 'gst-list', 'fa fa-percent', 0, 84, 'Active'),
  (85, 79, 'VAT Filing Head List', 'vat-filing-head-list', 'fa fa-file-text-o', 0, 85, 'Active'),
  (86, 79, 'Currency List', 'currency-list', 'fa fa-money', 0, 86, 'Active'),
  (87, 79, 'Settings', 'settings', 'fa fa-cogs', 0, 87, 'Active'),
  (88, 79, 'Country List', 'country-list', 'fa fa-globe', 0, 88, 'Active'),
  (89, 79, 'Addt Charges Type List', 'addt-charges-type-list', 'fa fa-tag', 0, 89, 'Active'),
  (90, 78, 'Company Info', NULL, 'fa fa-building', 0, 90, 'Active'),
  (91, 90, 'Company Details', 'company-list', 'fa fa-address-book', 0, 91, 'Active'),
  (92, 90, 'Bank Details', 'company-bank-list', 'fa fa-bank', 0, 92, 'Active'),
  (93, 90, 'Cash Category', 'cash-category-list', 'fa fa-tags', 0, 93, 'Active'),
  (94, 90, 'User List', 'user-list', 'fa fa-user', 0, 94, 'Active'),
  (95, 78, 'Customer Info', NULL, 'fa fa-address-book', 0, 95, 'Active'),
  (96, 95, 'Customer List', 'customer-list', 'fa fa-users', 0, 96, 'Active'),
  (97, 95, 'Customer Contact Info', 'customer-contact-list', 'fa fa-building', 0, 97, 'Active'),
  (98, 95, 'Customer Opening Balance', 'customer-opening-balance-list', 'fa fa-balance-scale', 0, 98, 'Active'),
  (99, 78, 'Vendor Info', NULL, 'fa fa-address-card', 0, 99, 'Active'),
  (100, 99, 'Vendor List', 'vendor-list', 'fa fa-users', 0, 100, 'Active'),
  (101, 99, 'Vendor Contact Info', 'vendor-contact-list', 'fa fa-building', 0, 101, 'Active'),
  (102, 99, 'Vendor Opening Balance', 'vendor-opening-balance-list', 'fa fa-balance-scale', 0, 102, 'Active'),
  (103, 78, 'Accounts', NULL, 'fa fa-money', 0, 103, 'Active'),
  (104, 103, 'Account Head', 'account-head-list', 'fa fa-university', 0, 104, 'Active'),
  (105, 103, 'Sub-Account Head', 'sub-account-head-list', 'fa fa-bank', 0, 105, 'Active'),
  (106, 103, 'Opening Balance', 'opening-balance-list', 'fa fa-balance-scale', 0, 106, 'Active'),
  (107, 0, 'Access Control', NULL, NULL, 1, 107, 'Active'),
  (108, 0, 'Access Control', NULL, 'fa fa-shield', 0, 108, 'Active'),
  (109, 108, 'Menu Management', 'menu-management', 'fa fa-list-alt', 0, 109, 'Active'),
  (110, 108, 'Role Management', 'role-management', 'fa fa-user-secret', 0, 110, 'Active'),
  (111, 108, 'Role Permissions', 'role-permission', 'fa fa-key', 0, 111, 'Active');
