            ...
            <table class="table table-striped table-bordered table-hover" id="statement-table">
                <thead>
                    <tr class="bg-gray-light">
                        ...
                        <th style="width: 120px;">Ref / V.No</th>
                        <th style="width: 150px;">Transaction Type</th>
                        <th style="width: 100px;">Mode</th>
                        <th style="width: 180px;">Bank / Account Name</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge <?php echo $row['mode'] === 'Cash' ? 'bg-green' : 'bg-blue'; ?>">
                    ...
                    ?>
                        <tr>
                            <td colspan="10" class="text-center text-muted">No transactions found for the selected period and account filter.</td>
                        </tr>
                    <?php 
                    } 
                    ?>
                ...
                <tfoot>
                    <tr class="bg-gray-light text-bold" style="font-size: 15px; border-top: 2px solid #ddd;">
                        <td colspan="7" class="text-right">Total Transacted:</td>
