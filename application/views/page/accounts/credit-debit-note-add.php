            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" name="note_no" class="form-control" required value="<?php echo isset($edit_data) ? htmlspecialchars($edit_data['note_no']) : ''; ?>">
                    </div>
                    <div class="col-md-3 form-group">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <?php echo form_dropdown('company_id', $company_opt, isset($edit_data) ? $edit_data['company_id'] : '', 'class="form-control" required'); ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        <label>Tender Enquiry <span class="text-danger">*</span></label>
                        <?php echo form_dropdown('tender_enquiry_id', $enquiry_opt, isset($edit_data) ? $edit_data['tender_enquiry_id'] : '', 'id="tender_enquiry_id" class="form-control" required'); ?>
                    </div>

                    <div class="col-md-3 form-group">
                        <label>Reference Invoice <span class="text-danger">*</span></label>
                        <select name="reference_invoice_id" id="reference_invoice_id" class="form-control" required data-selected="<?php echo isset($edit_data) ? $edit_data['reference_invoice_id'] : ''; ?>">
                ...
                <div class="row">
                    <div class="col-md-3 form-group">
                        ...
                        <?php echo form_dropdown('currency_id', $currency_opt, isset($edit_data) ? $edit_data['currency_id'] : '', 'class="form-control" required'); ?>
                    </div>
                    <div class="col-md-3 form-group">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="itemTable">
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="11" class="text-right">Sub Total</th>
                            ...
                            <tr>
                                <th colspan="11" class="text-right">Total Discount</th>
                                <th class="text-right"><input type="text" name="discount_amount" id="discount_amount" class="form-control text-right" readonly value="<?php echo isset($edit_data) ? $edit_data['discount_amount'] : '0.00'; ?>"></th>
                                <th></th>
                            </tr>
                            <tr>
                                <th colspan="11" class="text-right">Taxable Amount</th>
                            ...
                            <tr>
                                <th colspan="11" class="text-right">Total Tax Amount</th>
                            ...
                            <tr>
                                <th colspan="11" class="text-right">Round Off</th>
                            ...
                            <tr>
                                <th colspan="11" class="text-right text-primary" style="font-size:18px;">Total Amount</th>
