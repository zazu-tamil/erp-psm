                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo site_url('print-receipt/' . $ls['cash_inward_id']); ?>" target="_blank"
                                    class="btn btn-info btn-xs" title="Print Receipt"><i class="fa fa-print"></i></a>
                            </td>
                            <td class="text-center">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input class="form-control" type="date" name="inward_date"
                                                id="inward_date" value="<?php echo date('Y-m-d'); ?>" required="true" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Company</label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input class="form-control" type="date" name="inward_date"
                                                id="edit_inward_date" value="<?php echo date('Y-m-d'); ?>" required="true" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Company</label>
