                ...
                <tbody>
                    ...
                    foreach ($record_list as $j => $ls) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $ls['nature_type'] ?> </td>
                            <td><?php echo ($ls['ac_table'] == 1 ? 'Yes' : 'No') ?></td>
                            <td><?php echo $ls['status'] ?></td>
                            <td class="text-center">
                                <button data-toggle="modal" data-target="#edit_modal"
                                    value="<?php echo $ls['account_head_id'] ?>" class="edit_record btn btn-primary btn-xs"
                                    title="Edit"><i class="fa fa-edit"></i></button>
                            </td>
                            <td class="text-center">
                                <button value="<?php echo $ls['account_head_id'] ?>"
                        ...
                        <form method="post" action="" id="frmadd">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="account_head_name"
                                        id="account_head_name" value="">
                                </div>
                                <div class="form-group">
