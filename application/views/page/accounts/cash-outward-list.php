                ...
                <tbody>
                    <?php foreach ($record_list as $j => $ls) { ?>
                        <tr>
                            ...
                            <td><?php echo date('d-m-Y', strtotime($ls['outward_date'])) ?><br /><?php echo $ls['ac_type'] . ($ls['ac_type'] == 'Bank' && !empty($ls['bank_name']) ? ' (' . $ls['bank_name'] . ')' : '') ?>
                            </td>
                        ...
                        <form method="post" action="" id="frmadd" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Company</label>
                                        <?php echo form_dropdown('company_id',$company_name_opt, set_value('company_id', 1), 'id="company_id" class="form-control select2" required'); ?>
                                    </div>
