        ...
        <div class="box-body">
            <form method="post" action="" id="frmsearch">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="srch_inward_no">Inward No</label>
                        <input type="text" name="srch_inward_no" id="srch_inward_no" class="form-control"
                            value="<?php echo set_value('srch_inward_no', $srch_inward_no); ?>"
                            placeholder="Search the Our Iward No">
                    </div>
                    ...
                    <?php if (!empty($record_list)): ?>
                        <?php foreach ($record_list as $j => $row): ?>
                            <tr>
                                ...
                                <td><strong><?php echo htmlspecialchars($row['inward_no']); ?></strong></td>
                                <td><?php echo htmlspecialchars($row['vendor_name'] ?? '-'); ?></td>

                                <!-- EDIT -->
                                <td class="text-center">
                                    <a href="<?php echo site_url('vendor-pur-inward-edit/' . $row['vendor_pur_inward_id']); ?>"
                                ...
                                <!-- DELETE -->
                                <td class="text-center">
                                    <button value="<?php echo $row['vendor_pur_inward_id']; ?>"
