                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <div class="form-group col-md-3">
                            ...
                            <?php echo form_dropdown('srch_vendor_id', ['' => 'All'] + $vendor_opt, set_value('srch_vendor_id' , $srch_vendor_id), 'id="srch_vendor_id" class="form-control"'); ?>
                        </div>
                    ...
                    <?php if (!empty($record_list)): ?>
                        <?php foreach ($record_list as $j => $row): ?>
                            <tr>
                                ...
                                <!-- DELETE -->
                                <td class="text-center">
                                    <button value="<?php echo $row['vendor_pur_inward_id']; ?>" class="del_record btn btn-danger btn-xs"
                                        title="Delete">
