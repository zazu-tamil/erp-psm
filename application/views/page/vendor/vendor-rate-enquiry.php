                ...
                <fieldset class="tender-inward">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <?php echo form_dropdown('customer_id', ['' => 'Select'] + $customer_opt, set_value('customer_id'), 'id="srch_customer_id" class="form-control "'); ?>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="srch_tender_enquiry_id">Tender Enquiry No</label>
                            <?php echo form_dropdown(
                                'srch_tender_enquiry_id',
                                ['' => 'Select'] + $tender_enquiry_opt,
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <?php echo form_dropdown('vendor_id', ['' => 'Select'] + $vendor_opt, set_value('vendor_id'), 'id="srch_vendor_id" class="form-control "'); ?>
                        </div>
