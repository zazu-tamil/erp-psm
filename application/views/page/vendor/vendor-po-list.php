        ...
        <div class="box-body">
            <form method="post" action="" id="frmsearch">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="srch_vendor_po_no">Vendor Po No</label>
                        <input type="text" name="srch_vendor_po_no" id="srch_vendor_po_no"
                            class="form-control"
                            value="<?php echo set_value('srch_vendor_po_no', $srch_vendor_po_no); ?>"
...
<script>
    jQuery(function ($) {
        ...
        $("#srch_vendor_po_no").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "<?php echo base_url('vendor/srch_vendor_po_no'); ?>",
                    type: "POST",
                    data: { search: request.term },
                    dataType: "json",
                    success: function (data) {
