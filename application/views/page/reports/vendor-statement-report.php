...
<section class="content" id="stmt-report-container">
    ...
    <div class="box box-premium no-print">
        ...
        <div class="box-body">
            <form method="post" action="<?php echo site_url('vendor-statement-report'); ?>" id="report-filter-form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" id="div-submit" style="<?php echo $show_dates_style; ?>">
                        ...
                        <div style="display: flex; gap: 8px;">
                            ...
                            <a href="<?php echo site_url('vendor-statement-report/reset'); ?>" class="btn btn-default" style="border-radius: 6px; font-weight: 600; padding: 7px 12px;" title="Reset Filter">
