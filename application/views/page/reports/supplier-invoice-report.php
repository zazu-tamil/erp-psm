...
<style>
    ...
    .stat-card.invoices { border-left-color: #3c8dbc; }
    .stat-card.taxable { border-left-color: #00c0ef; }
    .stat-card.vat { border-left-color: #f39c12; }
    .stat-card.grand-total { border-left-color: #00a65a; }
    ...
    .badge-supp-bill { background-color: #e0f2fe; color: #0369a1; border: 1px solid #bae6fd; }
    .badge-local-bill { background-color: #f3e8ff; color: #7e22ce; border: 1px solid #e9d5ff; }
    .badge-dp-bill { background-color: #ccfbf1; color: #0f766e; border: 1px solid #99f6e4; }
    .badge-customs-bill { background-color: #ffedd5; color: #c2410c; border: 1px solid #fed7aa; }
...
<section class="content">
    ...
    <div class="print-header text-center">
        <h2 style="margin: 0 0 5px 0; font-size: 20px; font-weight: bold; text-transform: uppercase;">SUPPLIER INVOICE REPORT</h2>
        <p style="margin: 0; font-size: 13px; color: #555;">
            <strong>Period:</strong> <?php echo !empty($srch_from_date) ? date('d-M-Y', strtotime($srch_from_date)) : 'Start'; ?>
            &nbsp;to&nbsp;
            ...
            <form method="post" action="<?php echo site_url('supplier-invoice-report'); ?>" id="frmSupplierInvoice">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 text-right" style="padding-top: 24px;">
                        ...
                        <a href="<?php echo site_url('supplier-invoice-report/reset'); ?>" class="btn btn-default" title="Reset Filters">
    ...
    <div class="box box-premium">
        <div class="box-header with-border">
            <h3 class="box-title">
                ...
                <span style="font-size: 13px; font-weight: normal; margin-left: 8px; opacity: 0.9;">
                    (<?php echo !empty($srch_from_date) ? date('d-m-Y', strtotime($srch_from_date)) : 'Start'; ?> to <?php echo !empty($srch_to_date) ? date('d-m-Y', strtotime($srch_to_date)) : 'End'; ?>)
                    &mdash; <?php echo htmlspecialchars($selected_vendor_name); ?>
                    &mdash; <span class="badge bg-navy"><?php echo htmlspecialchars($selected_bill_type_label); ?></span>
                </span>
            </h3>
        ...
        <div class="box-body table-responsive">
            <table class="table table-bordered table-striped table-hover" id="tbl_supplier_invoice" style="width: 100%;">
                <thead>
                    <tr>
                    ...
                    <?php if (!empty($records)): ?>
                        <?php $sno = 1; foreach ($records as $r): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo htmlspecialchars($r['vendor_vat_cr'] ? $r['vendor_vat_cr'] : '-'); ?></td>
                                <td><?php echo htmlspecialchars($r['tender_details'] ? $r['tender_details'] : '-'); ?></td>
                                <td class="text-center"><span class="badge bg-gray"><?php echo htmlspecialchars($r['currency_code']); ?></span></td>
                                ...
                                <td class="text-right" data-order="<?php echo (float)$r['total_amount']; ?>" style="font-weight: 700; color: #00a65a;">
                ...
                <tfoot>
                    <tr style="font-weight: 700; background-color: #edf2f7;">
                        ...
                        <th class="text-right" style="color: #00a65a;"><?php echo number_format($grand_total, 3); ?></th>
