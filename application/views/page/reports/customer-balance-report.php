...
<section class="content-header no-print">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i> Customer Report</a></li>
...
<style>
    ...
    #tbl_customer_balance td {
        vertical-align: middle;
        font-size: 13px;
    }
    #tbl_customer_balance tfoot th {
...
<section class="content">
    ...
    <div class="print-header text-center">
        <h2 style="margin: 0 0 5px 0; font-size: 20px; font-weight: bold; text-transform: uppercase;">CUSTOMER BALANCE REPORT</h2>
    ...
    <div class="box box-premium no-print">
        ...
        <div class="box-body">
            <form method="post" action="<?php echo site_url('customer-balance-report'); ?>" id="frmCustomerBalance">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 text-right" style="padding-top: 24px;">
                        ...
                        <a href="<?php echo site_url('customer-balance-report/reset'); ?>" class="btn btn-default" title="Reset Filters">
    ...
    <div class="row no-print">
        ...
        <div class="col-md-2 col-sm-4 col-xs-6">
            <div class="stat-card bills">
                <span class="label-text">Total Invoices</span>
                <div class="value-text"><?php echo number_format($summary['total_invoices'], 3); ?></div>
                <i class="fa fa-file-text-o icon-bg"></i>
            </div>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6">
            <div class="stat-card adv">
                <span class="label-text">Advance Received</span>
                <div class="value-text"><?php echo number_format($summary['advance_received'], 3); ?></div>
                <i class="fa fa-credit-card icon-bg"></i>
            </div>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6">
            <div class="stat-card paid">
                <span class="label-text">Invoice Receipts</span>
                <div class="value-text"><?php echo number_format($summary['invoice_receipts'], 3); ?></div>
                <i class="fa fa-check-circle-o icon-bg"></i>
            </div>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6">
            <div class="stat-card paid">
                <span class="label-text">Total Received</span>
                <div class="value-text"><?php echo number_format($summary['total_received'], 3); ?></div>
    ...
    <div class="box box-premium">
        <div class="box-header with-border">
            <h3 class="box-title">
                <i class="fa fa-list"></i> Customer Balances
                <small style="color: rgba(255,255,255,0.85); font-weight: normal; margin-left: 8px;">
                    (<?php echo count($record_list); ?> customers listed)
                </small>
            </h3>
        ...
        <div class="box-body table-responsive">
            <table class="table table-hover table-bordered table-striped" id="tbl_customer_balance" style="width: 100%;">
                <thead>
                    <tr>
                        <th class="text-center" style="width: 45px;">S.No</th>
                        <th>Customer Name</th>
                        <th class="text-right" style="width: 110px;">Opening Bal</th>
                        <th class="text-right" style="width: 115px;">Total Invoices</th>
                        <th class="text-right" style="width: 110px;">Advance Received</th>
                        <th class="text-right" style="width: 110px;">Invoice Receipts</th>
                        <th class="text-right" style="width: 115px;">Total Received</th>
                    ...
                    <?php if (!empty($record_list)): ?>
                        <?php foreach ($record_list as $i => $row): ?>
                            <tr>
                                ...
                                <td class="text-right" data-order="<?php echo (float)$row['total_invoices']; ?>">
                                    <?php echo number_format((float)$row['total_invoices'], 3); ?>
                                </td>
                                <td class="text-right" data-order="<?php echo (float)$row['advance_received']; ?>" style="color: #3c8dbc;">
                                    <?php echo number_format((float)$row['advance_received'], 3); ?>
                                </td>
                                <td class="text-right" data-order="<?php echo (float)$row['invoice_receipts']; ?>" style="color: #00a65a;">
                                    <?php echo number_format((float)$row['invoice_receipts'], 3); ?>
                                </td>
                                <td class="text-right" data-order="<?php echo (float)$row['total_received']; ?>" style="font-weight: 600;">
                                ...
                                <td class="text-center no-print">
                                    <form method="post" action="<?php echo site_url('customer-statement-report'); ?>" target="_blank" style="display:inline-block; margin:0;">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="10" class="text-center text-muted" style="padding: 25px;">
                                <i class="fa fa-info-circle fa-2x"></i><br>No customer records found for the selected filter.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
                <tfoot>
                    <tr class="bg-gray-light">
                        ...
                        <th class="text-right"><?php echo number_format($summary['total_invoices'], 3); ?></th>
                        <th class="text-right" style="color: #3c8dbc;"><?php echo number_format($summary['advance_received'], 3); ?></th>
                        <th class="text-right" style="color: #00a65a;"><?php echo number_format($summary['invoice_receipts'], 3); ?></th>
                        <th class="text-right"><?php echo number_format($summary['total_received'], 3); ?></th>
