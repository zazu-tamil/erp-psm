    ...
    <table style="width: 100%; border-collapse: collapse; font-family: Arial, Helvetica, sans-serif;">
        ...
        <tr>
            <td colspan="2" style="background-color: #f0f9ff; border: 1px solid #bae6fd; padding: 10px; text-align: center; font-size: 13pt; font-weight: bold; color: #0284c7;">
                <?php echo number_format($total_bills); ?>
            </td>
        ...
        <thead>
            <tr style="background-color: #1e293b; color: #ffffff;">
                ...
                <th style="padding: 8px; border: 1px solid #334155; text-align: center; width: 110px;">Bill / Inv No</th>
                <th style="padding: 8px; border: 1px solid #334155; text-align: center; width: 130px;">Bill Type</th>
                <th style="padding: 8px; border: 1px solid #334155; text-align: left; width: 200px;">Supplier Name</th>
            ...
            <?php if (!empty($records)): ?>
                <?php $sno = 1; foreach ($records as $r): ?>
                    <tr>
                        ...
                        <td style="padding: 6px 8px; border: 1px solid #cbd5e1; text-align: center;"><?php echo htmlspecialchars($r['bill_type']); ?></td>
                        <td style="padding: 6px 8px; border: 1px solid #cbd5e1; text-align: left;"><?php echo htmlspecialchars($r['vendor_name'] ?? '-'); ?></td>
                        <td style="padding: 6px 8px; border: 1px solid #cbd5e1; text-align: center;"><?php echo htmlspecialchars($r['vendor_vat_cr'] ? $r['vendor_vat_cr'] : '-'); ?></td>
                        <td style="padding: 6px 8px; border: 1px solid #cbd5e1; text-align: left;"><?php echo htmlspecialchars($r['tender_details'] ? $r['tender_details'] : '-'); ?></td>
