...
<style>
    ...
    #tbl_customer_invoice td {
        vertical-align: middle;
        font-size: 13px;
    }

    #tbl_customer_invoice tfoot th {
    ...
    @media print {
        ...
        #tbl_customer_invoice th:last-child,
        #tbl_customer_invoice td:last-child {
            display: none !important;
        }
    }
...
<section class="content">
    ...
    <div class="print-header text-center">
        <h2 style="margin: 0 0 5px 0; font-size: 20px; font-weight: bold; text-transform: uppercase;">CUSTOMER INVOICE
            REPORT</h2>
    ...
    <div class="box box-premium no-print">
        ...
        <div class="box-body">
            <form method="post" action="<?php echo site_url('customer-invoice-report'); ?>" id="frmCustomerInvoice">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="srch_customer_id" id="srch_customer_id" class="form-control select2">
                            ...
                            <?php foreach ($customer_list as $c): ?>
                                <option value=""></option>
                                <option value="<?php echo $c['customer_id']; ?>" <?php echo ($srch_customer_id == $c['customer_id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group col-md-3 text-right" style="padding-top: 24px;">
                        ...
                        <a href="<?php echo site_url('customer-invoice-report/reset'); ?>" class="btn btn-default"
                            title="Reset Filters">
    ...
    <div class="row no-print">
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="stat-card invoices">
                ...
                <span class="value-text"><?php echo number_format($total_invoices); ?></span>
    ...
    <div class="box box-premium">
        <div class="box-header with-border">
            <h3 class="box-title">
                <i class="fa fa-list"></i> Customer Invoices List
                <span style="font-size: 13px; font-weight: normal; margin-left: 8px; opacity: 0.9;">
                    ...
                    &mdash; <?php echo htmlspecialchars($selected_customer_name); ?>
                </span>
            </h3>
        ...
        <div class="box-body table-responsive">
            <table class="table table-bordered table-striped table-hover" id="tbl_customer_invoice"
                style="width: 100%;">
                <thead>
                    <tr>
                        <th style="width: 40px;" class="text-center">S.No</th>
                        <th style="width: 85px;" class="text-center">Date</th>
                        <th style="width: 110px;" class="text-center">Invoice No</th>
                        <th>Customer Name</th>
                        ...
                        foreach ($records as $r): ?>
                            <tr>
                                ...
                                <td class="text-center" data-order="<?php echo $r['invoice_date']; ?>">
                                    <?php echo date('d/m/Y', strtotime($r['invoice_date'])); ?></td>
                                <td class="text-center font-weight-bold" style="font-weight: 600;">
                                    <?php echo htmlspecialchars($r['invoice_no']); ?>
                                </td>
                                <td><?php echo htmlspecialchars($r['customer_name'] ?? '-'); ?></td>
                                <td class="text-center">
                                    <?php echo htmlspecialchars($r['client_vat_no'] ? $r['client_vat_no'] : ($r['customer_crno'] ? $r['customer_crno'] : '-')); ?>
                                </td>
                                <td><?php echo htmlspecialchars($r['tender_details'] ? $r['tender_details'] : ($r['enquiry_no'] ? $r['enquiry_no'] : '-')); ?>
                                </td>
                                ...
                                <td class="text-right" data-order="<?php echo (float) $r['tax_amount']; ?>">
                                    <?php echo number_format((float) $r['tax_amount'], (int) $r['decimal_point']); ?></td>
                                ...
                                <td class="text-center no-print">
                                    <a href="<?php echo site_url('tender-po-invoice-print/' . $r['tender_enq_invoice_id']); ?>"
