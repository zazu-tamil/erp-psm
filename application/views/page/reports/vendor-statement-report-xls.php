...
$col_count = empty($vendor_id) ? 7 : 6;
$card1_span = 2;
$card2_span = empty($vendor_id) ? 2 : 1;
$card3_span = 2;
$card4_span = 1;
?>
<!DOCTYPE html>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: Arial, Helvetica, sans-serif;">
        ...
        <tr>
            ...
            <td colspan="<?php echo $card2_span; ?>" style="padding: 10px 10px 2px 10px; background-color: #f4faf6; border-top: 1px solid #00a65a; border-left: 5px solid #00a65a; border-right: 1px solid #00a65a; vertical-align: bottom;">
                <span style="font-size: 9pt; font-weight: bold; color: #777d8c; text-transform: uppercase;">Purchases (Period)</span>
            </td>
            ...
            <td colspan="<?php echo $card3_span; ?>" style="padding: 10px 10px 2px 10px; background-color: #fdf5f4; border-top: 1px solid #dd4b39; border-left: 5px solid #dd4b39; border-right: 1px solid #dd4b39; vertical-align: bottom;">
                <span style="font-size: 9pt; font-weight: bold; color: #777d8c; text-transform: uppercase;">Paid (Period)</span>
            </td>
        ...
        <tr>
            ...
            <td colspan="<?php echo $card2_span; ?>" style="padding: 2px 10px 10px 10px; background-color: #f4faf6; border-bottom: 1px solid #00a65a; border-left: 5px solid #00a65a; border-right: 1px solid #00a65a; vertical-align: top; mso-number-format:'#,##0.000';">
                <span style="font-size: 16pt; font-weight: bold; color: #2c3e50;"><?php echo number_format($total_purchases_period, 3); ?></span>
            </td>
            ...
            <td colspan="<?php echo $card3_span; ?>" style="padding: 2px 10px 10px 10px; background-color: #fdf5f4; border-bottom: 1px solid #dd4b39; border-left: 5px solid #dd4b39; border-right: 1px solid #dd4b39; vertical-align: top; mso-number-format:'#,##0.000';">
                <span style="font-size: 16pt; font-weight: bold; color: #2c3e50;"><?php echo number_format($total_paid_period, 3); ?></span>
            </td>
        ...
        <tr style="background-color: #222d32; color: #ffffff; font-weight: bold;">
            ...
            <?php if (empty($vendor_id)) { ?>
                <td style="padding: 10px; border: 1px solid #222d32; text-align: left; font-size: 11pt; color: #ffffff; width: 20%;">Vendor</td>
            <?php } ?>
        ...
        if (!empty($record_list)) {
            ...
            <tr style="font-size: 11pt;">
                <td colspan="<?php echo empty($vendor_id) ? 7 : 6; ?>" style="padding: 20px; border: 1px solid #cbd5e1; text-align: center; color: #64748b; font-style: italic;">
        ...
        <tr style="background-color: #f1f5f9; font-weight: bold; font-size: 11pt; border-top: 2px solid #cbd5e1;">
            <td colspan="<?php echo empty($vendor_id) ? 4 : 3; ?>" style="padding: 10px; border: 1px solid #cbd5e1; text-align: right;">Total Period Movement:</td>
            <td style="padding: 10px; border: 1px solid #cbd5e1; text-align: right; color: #27ae60; mso-number-format:'#,##0.000';"><?php echo number_format($total_purchases_period, 3); ?></td>
            <td style="padding: 10px; border: 1px solid #cbd5e1; text-align: right; color: #c0392b; mso-number-format:'#,##0.000';"><?php echo number_format($total_paid_period, 3); ?></td>
