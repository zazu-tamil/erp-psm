...
<div class="page">
    ...
    <table class="no-border">
        <tr>
            ...
            <td style="width:50%; text-align:right; line-height:1.6;">
                ...
                <p><strong>Tender Ref No:</strong> <?php echo htmlspecialchars($record['tender_ref_no'] ?? 'N/A'); ?></p>
                <p><strong>Tender Enquiry No:</strong> <?php echo htmlspecialchars($record['tender_enquiry_no'] ?? 'N/A'); ?></p>
            </td>
        </tr>
    </table>
            ...
            <?php if (!empty($items)): ?>
                <?php foreach ($items as $i => $item): ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo htmlspecialchars($item['uom'] ?: $item['item_uom'] ?: '-'); ?></td>
    ...
    <div class="section">
        ...
        <p>2. Validity of quotation: 15 days from the date of issue.</p>
...
<div style="text-align:center; margin:30px 0;">
    <button onclick="window.print()" style="padding:10px 25px; font-size:14pt; cursor:pointer;">
        Print
    </button>
</div>
