            ...
            <form method="post" action="" id="frmsearch">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="form-group">
                            <?php echo form_dropdown('srch_customer_contact_id', ['' => 'All'] + ($customer_contact_opt ?? []), $srch_customer_contact_id, 'id="srch_customer_contact_id" class="form-control select2" '); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
