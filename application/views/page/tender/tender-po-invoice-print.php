...
<head>
    <meta charset="UTF-8">
    <title>Tender Invoice - <?php echo htmlspecialchars($record['quotation_no'] ?? ''); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="info-row">
                ...
                <div class="info-cell right">
                    <div><span class="info-label">Date:</span>
                        <?php echo date('d-m-Y', strtotime($record['invoice_date'])); ?></div>
                    <div><span class="info-label">Invoice No:</span>
                        <?php echo $record['invoice_no']; ?></div>
