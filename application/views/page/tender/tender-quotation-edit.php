                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="checkbox" name="is_technical_bid" id="is_technical_bid" value="1"
                                <?php echo (($header['is_technical_bid']) == '1' ? 'checked' : ''); ?>>
                        </div>
                        <div class="form-group col-md-3">
                            <label>Quotation Option Name</label>
                            <input type="text" name="technical_option_name" id="technical_option_name"
                                class="form-control" value="<?php echo $header['technical_option_name']; ?>"
                                placeholder="Quotation Option Name  - OPT1">
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="chk_addt_charges_type_id"
                                        ...
                                        <?php  if($info['tender_quote_addtchrg_id'] != '' ) echo "Checked"; ?>>
                                    <input type="hidden" class="tender_quote_addtchrg_id"
                                        id="tender_quote_addtchrg_id<?php echo $info['addt_charges_type_id'] ?>"
                                        name="tender_quote_addtchrg_id[<?php echo $info['addt_charges_type_id'] ?>]"
                                        value="<?php echo $info['tender_quote_addtchrg_id'] ?? 0 ;?>">
                                </td>
                                </td>
                                <td><label
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control addt_charges_amt"
                                        name="addt_charges_amt[<?php echo $info['addt_charges_type_id'] ?>]"
                                        value="<?php echo $info['addt_charges_amt'] ?>">
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control addt_charges_vat"
                                        name="addt_charges_vat[<?php echo $info['addt_charges_type_id'] ?>]"
                                        value="<?php echo ($info['tender_quote_addtchrg_id'] != '' ) ? $info['vat'] : $info['addt_charges_vat'] ?>">
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control addt_charges_vat_amt"
                                        name="addt_charges_vat_amt[<?php echo $info['addt_charges_type_id'] ?>]"
                                        value="<?php echo $info['addt_charges_vat_amt'] ?>" readonly>
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control addt_charges_tot_amt"
                                        name="addt_charges_tot_amt[<?php echo $info['addt_charges_type_id'] ?>]"
                                        value="<?php echo $info['addt_charges_tot_amt'] ?>" readonly>
                                </td>
                            </tr>
                            <?php } ?>
                        </table>
