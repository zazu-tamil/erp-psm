                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="item_desc" id="add_item_desc" class="form-control" placeholder="Enter your Description"
                                            rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control add_calc" type="text" name="qty" id="add_qty"
                                            data-field="qty" placeholder="Qty">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Rate</label>
                                        <input class="form-control add_calc" type="text" name="rate" id="add_rate"
                                            data-field="rate" placeholder="Rate">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>VAT (%)</label>
                                        <input class="form-control add_calc" type="text" name="vat" id="add_vat"
                                            data-field="vat" placeholder="VAT">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label>Select Vendor</label>
                                        <?php echo form_dropdown('vendor_id', ['' => 'Select Vendor'] + $vendor_opt, set_value('vendor_id'), 'id="add_vendor_id" class="form-control"'); ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Amount</label>
                        ...
                        <form method="post" action="<?php echo site_url('in-stock-item-list'); ?>" id="frmedit"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label>Select Vendor</label>
                                        <?php echo form_dropdown('vendor_id', ['' => 'Select Vendor'] + $vendor_opt, set_value('vendor_id'), 'id="edit_vendor_id" class="form-control"'); ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Amount</label>
