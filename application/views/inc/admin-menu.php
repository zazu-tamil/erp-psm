...
<li class="treeview 
    ...
    <ul class="treeview-menu">
        ...
        <li class="<?= ($current_page === 'customer-invoice-receipt') ? 'active' : '' ?>">
            <a href="<?= site_url('customer-invoice-receipt') ?>">
                <i class="fa fa-list"></i> Tender Receipt List
            </a>
        </li>
        ...
        <li
            ...
            <ul class="treeview-menu">
                <li class="<?= ($current_page === 'vendor-rate-enquiry') ? 'active' : '' ?>">
                    <a href="<?= site_url('vendor-rate-enquiry') ?>"><i class="fa fa-plus-square"></i> Add Supplier
                        Enquiry
                        Enquiry</a>
                </li>
        ...
        <li
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?= ($current_page === 'delivery-partner-bill-list') ? 'active' : '' ?>">
                    <a href="<?= site_url('delivery-partner-bill-list') ?>"><i class="fa fa-list"></i> Delivery Partner
                        Bill
                        List</a>
                </li>
...
<li class="treeview 
    ...
    <ul class="treeview-menu">
        ...
        <li
            ...
            <ul class="treeview-menu">
                <li class="<?= ($current_page === 'sales-purchase-report') ? 'active' : '' ?>">
                    <a href="<?= site_url('sales-purchase-report') ?>"><i class="fa fa-list"></i> VAT Return Form
                        Summary</a>
                </li>
        ...
        <li class="<?= ($this->uri->segment(1) == 'account-trial-balance') ? 'active' : '' ?>">
            <a href="<?= site_url('account-trial-balance') ?>">
                <i class="fa fa-balance-scale"></i> Account Trial Balance
            </a>
        </li>
    </ul>
</li>
...
<li
    ...
    <ul class="treeview-menu">
        ...
        <li class="<?= ($current_page === 'contra-entry') ? 'active' : '' ?>">
            <a href="<?= site_url('contra-entry') ?>">
                <i class="fa fa-exchange"></i> Contra Entry
            </a>
        </li>
        <!-- 
        <li class="<?= ($current_page === 'petty-cash') ? 'active' : '' ?>">
...
<li class="treeview <?= in_array($current_page, $g_master) ? 'active' : '' ?>">
    ...
    <ul class="treeview-menu">
        ...
        <!-- Company Info -->
        <li
            class="treeview <?= in_array($current_page, ['company-list', 'user-list', 'company-bank-list', 'cash-category-list']) ? 'active' : '' ?>">
            <a href="#">
            ...
            <ul class="treeview-menu">
                ...
                <li class="<?= ($current_page === 'cash-category-list') ? 'active' : '' ?>">
                    <a href="<?= site_url('cash-category-list') ?>">
                        <i class="fa fa-tags"></i> Cash Category
                    </a>
                </li>
        ...
        <!-- Customer Info -->
        <li
            class="treeview <?= in_array($current_page, ['customer-list', 'customer-contact-list', 'customer-opening-balance-list']) ? 'active' : '' ?>">
            <a href="#">
        ...
        <li
            class="treeview <?= in_array($current_page, ['account-head-list', 'sub-account-head-list', 'voucher-type-list', 'opening-balance-list']) ? 'active' : '' ?>">
            <a href="#">
