...
$route['vendor-contact-list/(:num)'] = 'master/vendor_contact_list/$1';
...
$route['customer-contact-list/(:num)'] = 'master/customer_contact_list/$1';
...
$route['customer-receipt-print/(:num)'] = 'payment/customer_receipt_print/$1';
...
$route['item-inward-outward-report'] = 'reports/item_inward_outward_report';
$route['item-inward-outward-details-ajax'] = 'reports/item_inward_outward_details_ajax';
...
$route['dp-custom-invoice-report'] = 'reports/dp_custom_invoice_report';
$route['dp-custom-invoice-report/(:any)'] = 'reports/dp_custom_invoice_report/$1';
